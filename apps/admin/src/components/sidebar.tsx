...
const navItems: { name: string; href: string; icon: string; roles: Role[] }[] = [
  ...
  // App Comments (Reader Phase 2 Task 6) - moderation for the mobile app's
  // AppComment threads (separate model from the web article Comment above).
  { name: "App Comments", href: "/app-comments", roles: EDITORIAL, icon: "M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" },
  ...
  return (
    <>
      ...
      <header className="admin-topbar">
        ...
        <img src="/logo-horizontal-red.webp" alt="Rayalaseema News" style={{ height: 26 }} />
      </header>
      ...
      >
        ...
        <div style={{ padding: "18px 20px", borderBottom: "1px solid #1f2937", display: "flex", alignItems: "center" }}>
          ...
          <img src="/logo-horizontal-white.webp" alt="Rayalaseema News" style={{ height: 44, width: "auto", display: "block" }} />
        </div>
