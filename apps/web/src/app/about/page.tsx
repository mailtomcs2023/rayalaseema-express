    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main style={{ maxWidth: 800, margin: "0 auto", padding: "40px 16px" }}>
        ...
        <div className="article-body" style={{ fontSize: 16, lineHeight: 2, color: "#333" }}>
          <p>
            రాయలసీమ ప్రాంత వార్తలకు ప్రత్యేకంగా ఏర్పడిన డిజిటల్ తెలుగు వార్తా సంస్థ{" "}
            <strong>రాయలసీమ న్యూస్</strong>. ప్రధాన మీడియా సంస్థల కవరేజీలో తగినంత చోటు దక్కని ఈ ప్రాంత
            వార్తలను గ్రామ స్థాయి నుంచి జిల్లా స్థాయి వరకు ప్రతిరోజూ తెలుగులో అందిస్తున్నాం. వాస్తవాలను
            వాస్తవాలుగా, నిష్పక్షపాతంగా అందించడం మా విధానం.
          </p>
          ...
          <p>
            ప్రతి కథనం మా <Link href="/editorial-standards">సంపాదకీయ ప్రమాణాలకు</Link> లోబడి ఉంటుంది.
            పొరపాటు జరిగినప్పుడు <Link href="/corrections-policy">సవరణల విధానం</Link> ప్రకారం బహిరంగంగా
            సరిదిద్దుతాం. మా <Link href="/ethics-policy">నైతిక నియమావళి</Link>,{" "}
            <Link href="/diversity-policy">వైవిధ్య విధానం</Link>, <Link href="/feedback-policy">పాఠకుల అభిప్రాయాల విధానం</Link>{" "}
            అన్నీ బహిరంగంగా ప్రచురితమై ఉన్నాయి. సంపాదకీయ బాధ్యతలు నిర్వహించే బృందం వివరాలు{" "}
            <Link href="/masthead">మాస్ట్‌హెడ్</Link> పేజీలో ఉన్నాయి.
          </p>
          ...
          <p>
            వార్తా సమాచారం, సవరణలు, ఇతర సంప్రదింపుల కోసం{" "}
            <Link href="/contact">సంప్రదింపు పేజీ</Link> చూడవచ్చు. ఎడిటోరియల్ డెస్క్:{" "}
